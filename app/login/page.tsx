...
import { getAuth, signInWithEmailAndPassword, GoogleAuthProvider, signInWithPopup, signInWithRedirect, getRedirectResult, setPersistence, browserLocalPersistence, sendEmailVerification } from "firebase/auth"
...
function LoginContent() {
    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            // Error code 'auth/popup-closed-by-user' is fine, don't show an error toast
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white py-12 relative z-[10]">
            <Card className="w-full max-w-md shadow-lg border-blue-100 relative z-[50]">
                ...
                <CardContent className="space-y-4">
                    <Button type="button" variant="outline" className="w-full border-gray-200 hover:bg-gray-50 mb-2" onClick={handleGoogleLogin} disabled={isLoading}>
            ...
            <div className="absolute bottom-4 left-0 right-0 text-center space-y-2 z-[50]">
                <Link href="/" className="block text-sm text-blue-600 hover:underline font-medium mb-2">
