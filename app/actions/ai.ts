    ...
    try {
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a helpful assistant for the famio \u2014 The Future of Human Connection social platform. Write a warm, engaging, and family-friendly post caption based on the user's input. Keep it under 280 characters if possible, but prioritize natural tone. Add emojis where appropriate."
                },
                {
                    role: "user",
    ...
    try {
        ...
        const response = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are a helpful assistant for the famio \u2014 The Future of Human Connection social platform. Write a short, positive, and supportive comment in response to a post. Keep it casual and friendly. Max 1-2 sentences. Add an emoji."
                },
                {
                    role: "user",
