                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <Link href="/" className="flex items-center gap-3">
                            <img src="/icons/PWAIcon.jpg" className="w-10 h-10 rounded-xl object-cover" alt="Famio" className="w-7 h-7 rounded-xl" />
                            <div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center justify-center space-y-4">
                        <div className="flex items-center gap-2">
                            <img src="/icons/PWAIcon.jpg" className="w-10 h-10 rounded-xl object-cover" alt="Famio" className="w-6 h-6 rounded-lg" />
                            <div>
