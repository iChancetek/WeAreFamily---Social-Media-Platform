            ...
            {!isPinterest && isPinterestLinkPreview && pinterestPreview && (
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent p-4 text-white flex flex-col justify-end pt-16 pointer-events-none">
                    <div className="flex items-center gap-2 mb-1">
                        {pinterestPreview.source === 'pinterest' ? (
                            <>
                            ...
                            <>
                                <div className="bg-blue-600 rounded-full p-1 shadow-sm"><Globe className="w-3 h-3 text-white" /></div>
                                <span className="text-xs font-bold uppercase tracking-wider opacity-95 drop-shadow-md">Article / Link</span>
                            </>
                        )}
                    </div>
